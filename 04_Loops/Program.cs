...
namespace _04_Loops
{
    internal class Program
    {
        ...
        {
            #region For Döngüsü
            // Döngüler 1+2+3+4+5+6 normal zamanda yaptığımız toplama işlemi böyledir
            // Programlamada ise 3+3=6+4=10+5=15+6=21  şeklinde yapılır
            ...
            //ones = number % 10;
            //tens = (number%100) /10; 
            //hundreds = number / 100;// 4.56 ise girilen sayı tam kısmı olan 4 ü alır çünkü int türünde tanımladık
